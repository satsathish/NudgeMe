...
@REM kubectl exec -n sat nudgeme-postgresql-0 -- pg_dump -U nudgeme nudgeme > nudgeme-backup.sql  
...
@REM kubectl exec -i -n sat nudgeme-postgresql-0 -- psql -U nudgeme nudgeme < nudgeme-backup.sql
